...
<ul class="tabs menu">
<li <?php echo ($page == 'Home') ? 'class="current"' : '';?>><a href="index.php" ><span>Home</span></a> 
</li>
...
<a href="#">Services </a>
 <ul class="child">
<li <?php echo ($page == 'Surveillance') ? 'class="current"' : '';?>><a href="service-surveillance.php" >Surveillance</a></li>
<li <?php echo ($page == 'Networking') ? 'class="current"' : '';?>><a href="service-networking.php" >Networking</a></li>
<li <?php echo ($page == 'Alarm') ? 'class="current"' : '';?>><a href="service-alarm.php">Alarm</a></li>
<li <?php echo ($page == 'PhoneSystem') ? 'class="current"' : '';?>><a href="service-phonesystem.php"  >Phone System</a></li>
<li <?php echo ($page == 'AccessControl') ? 'class="current"' : '';?>><a href="service-accesscontrol.php">Access Control</a></li>
<li <?php echo ($page == 'Intercom') ? 'class="current"' : '';?>><a href="service-intercom.php">Intercom</a></li>
<li <?php echo ($page == 'Karaoke') ? 'class="current"' : '';?>><a href="service-karaoke.php">Karaoke</a></li>
<li <?php echo ($page == 'PointofSale') ? 'class="current"' : '';?>><a href="service-pointofsale.php">Point of Sale</a></li>
<li <?php echo ($page == 'CreditCardMerchant') ? 'class="current"' : '';?>><a href="service-creditcardmerchant.php">Credit Card Merchant</a></li>
<li <?php echo ($page == 'OnlineOrdering') ? 'class="current"' : '';?>><a href="service-onlineordering.php">Online Ordering</a></li>
</ul>
...
<li <?php echo ($page == 'comingsoon') ? 'class="current"' : '';?>><a href="comingsoon.php" >Condo</a></li>
<li <?php echo ($page == 'comingsoon') ? 'class="current"' : '';?>><a href="comingsoon.php">Supermarket</a></li>
<li <?php echo ($page == 'comingsoon') ? 'class="current"' : '';?>><a href="comingsoon.php"  >Restaurant</a></li>
</ul>
</li>
